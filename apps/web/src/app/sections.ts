...
export const SECTIONS: SectionDef[] = [
  ...
  { key: "privateTutor", labelKey: "sections.privateTutor.label", icon: GraduationCap, blurbKey: "sections.privateTutor.blurb", group: "work" },
...
const ENTRY_PRIMARY = new Set<SectionKey>(["dashboard", "privateTutor", "mail", "localLibrary", "task", "workflowMemory", "projects", "me"]);
...
const ENTRY_ORDER: SectionKey[] = ["dashboard", "privateTutor", "mail", "localLibrary", "task", "workflowMemory", "projects", "me"];
