...
if (process.argv.includes("--check")) {
  ...
  const expectations = [
    ...
    [js, "/api/m3", "M3 state read model API action"],
    [js, "/api/m3/private-catalog", "M3 private catalog API action"],
    [js, "/api/m3/signed-bundles", "M3 signed bundle API action"],
    [js, "/api/m3/lifecycle-recipes", "M3 lifecycle recipe API action"],
    [js, "/api/m3/ai-usage", "M3 AI usage ledger API action"],
    [js, "/api/m3/audit-export", "M3 audit export API action"],
    [js, "readableLifecycleRecipe", "M3 lifecycle recipe formatter"],
    [js, "readableLifecycleAction", "M3 lifecycle action result formatter"],
    [js, "readablePrivateCatalogEntry", "M3 private catalog formatter"],
    [js, "readableSignedBundle", "M3 signed bundle formatter"],
    [js, "readableQuotaDecision", "M3 quota decision formatter"],
    [js, "readableLedgerEntry", "M3 ledger entry formatter"],
    [js, "readableAuditExportRequest", "M3 audit export formatter"],
