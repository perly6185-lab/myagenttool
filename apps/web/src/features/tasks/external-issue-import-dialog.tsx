...
const COPY = {
  zh: {
    title: "导入外部 Issue",
    description: "读取外部 Issue 并创建可规划、可执行的本地 Issue。此操作不会立即启动 AI。",
    provider: "来源平台",
    project: "归属本地项目",
    repository: "外部仓库",
    ...
    boundary: "导入后会打开本地 Issue。确认目标和材料后，再选择“交给 AI 开始处理”。",
    cancel: "取消",
    import: "导入为本地 Issue",
    importing: "正在读取并导入…",
  ...
  en: {
    ...
    description: "Read an external issue and create a local issue that can be planned and executed. AI will not start yet.",
    ...
    boundary: "The local issue opens after import. Review its goal and materials, then choose “Let AI start”.",
    cancel: "Cancel",
    import: "Import as local issue",
