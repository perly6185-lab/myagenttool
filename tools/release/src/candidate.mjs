...
const checks = [
  ...
  { id: "p4-data-driven-writeback", command: "node", args: ["--test", "test/ledger-upserts.test.mjs", "test/p4-13-security.test.mjs", "test/integration/channel-ledger-mutation-journey.test.mjs"], cwd: "apps/server", evidence: ["multi-file safe writeback", "compensation", "restart recovery", "privacy redaction", "private snapshots", "Channel data-driven mutation"] },
