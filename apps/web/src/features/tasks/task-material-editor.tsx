...
const COPY = {
  zh: {
    ...
    limit: "最多 6 个文件，每个不超过 5MB",
    retry: "重试",
    remove: "移除 {{name}}",
    rejected: "部分文件未能添加。单个文件不能超过 5MB，最多添加 6 个非空文件。",
  ...
  en: {
    ...
    limit: "Up to 6 files, 5MB each",
    retry: "Retry",
    remove: "Remove {{name}}",
    rejected: "Some files could not be added. Each file must be non-empty and under 5MB; up to 6 files are allowed.",
