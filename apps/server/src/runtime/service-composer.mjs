...
import { createApplicationResultArtifactService } from "../services/application-result-artifacts.mjs";
import { createApplicationRenderResultService } from "../services/application-render-results.mjs";
import { createApplicationResultRetentionService } from "../services/application-result-retention.mjs";
...
export function createServerRuntimeServices({
  ...
  } = createApplicationRenderResultService({
    state,
    now,
    nextId,
    appendEvent,
  ...
  } = createApplicationResultArtifactService({
    state,
    now,
    nextId,
    appendEvent,
  ...
  } = createApplicationResultRetentionService({
    state,
    now,
    appendEvent,
    persistStateSoon,
