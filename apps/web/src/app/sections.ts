...
export const SECTIONS: SectionDef[] = [
  ...
  { key: "approvals", label: "Approvals", icon: Inbox, blurb: "Every pending human decision in one queue" },
  { key: "evidence", label: "Evidence", icon: ClipboardCheck, blurb: "Per-run trust rollup: review, audit, troubleshooting" },
  ...
  { key: "routines", label: "Routines", icon: Repeat, blurb: "Scheduled autonomous checks and their findings" },
