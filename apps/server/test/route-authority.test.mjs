...
test("configuration and governance writes require professional management", () => {
  const cases = [
    ...
    ["PATCH", "/api/hosts/ssh_target_1/health/monitoring"],
...
test("execution, approval, recovery, and retry writes admit operators", () => {
  const cases = [
    ...
    ["POST", "/api/hosts/ssh_target_1/assistant/diagnose"],
    ["POST", "/api/hosts/ssh_target_1/assistant/cases"],
    ["POST", "/api/hosts/ssh_target_1/assistant/remediation-plan"],
    ["POST", "/api/hosts/ssh_target_1/assistant/remediation-plans/hrp_1/confirm"],
    ["POST", "/api/hosts/ssh_target_1/assistant/remediation-plans/hrp_1/recheck"],
    ["POST", "/api/hosts/ssh_target_1/health/check"],
